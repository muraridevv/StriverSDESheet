...
public class CountDaysWithoutMeetings {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        "Number of days not covered by meetings: "
            + result1); // Output should be 3 (Days 3, 6, 7, 8, and 9)
    ...
    System.out.println(
        "Number of days not covered by meetings: " + result2); // Output should be 2 (Days 9 and 10)
  }
}
