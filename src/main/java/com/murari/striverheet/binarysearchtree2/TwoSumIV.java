...
public class TwoSumIV {
    ...
    public boolean findTarget(TreeNode root, int k) {
        ...
        //find the two sum in the result list-> Now it has become similar to two sum problem in sorted array
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Does there exist two elements with sum " + k + " in the BST? " + twoSumIV.findTarget(root, k));
    }
}
