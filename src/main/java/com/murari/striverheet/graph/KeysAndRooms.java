...
public class KeysAndRooms {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Can visit all rooms (test 1): " + solution.canVisitAllRooms(rooms1)); // Output: true
        System.out.println("Can visit all rooms (test 2): " + solution.canVisitAllRooms(rooms2)); // Output: false
    }
}
