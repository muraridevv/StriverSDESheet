...
public class JsonPathParserTest {
    ...
    void testInvalidJsonPathSyntax() {
        ...
        Exception exception = assertThrows(IllegalArgumentException.class, () -> JsonPathParser.parseJsonPath(jsonPath));
    ...
    void testMissingFilterInJsonPath() {
        ...
        Exception exception = assertThrows(RuntimeException.class, () -> JsonPathParser.buildJsonFromJsonPath(jsonPath));
